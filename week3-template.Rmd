...
# find the highest points in canterbury 
# like filtering but based on geometries!
...
```{r include=TRUE}
# find all of the data NOT in canterbury
...
# assignment 2: sometimes just knowing the number of things that intersect is helpful
...
```{r include=TRUE}
# filter and tell it if you want to find intersections, disjoints, etc.
nz_height %>% 
  st_filter(y = canterbury, .predicate = st_intersects)

# st_intersection is similar to a join
# adds attributes from canterbury to the points in nz_height
...
# union combines geometries of all western states
...
random_points <- random_df %>% 
  # turn dataframe into spatial object and tell what columns to use as coordinates
...
# keeps the region names unlike above
```
